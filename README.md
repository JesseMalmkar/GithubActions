[![Run App Jesse Malmkar](https://github.com/JesseMalmkar/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/JesseMalmkar/GithubActions/actions/workflows/run-app.yaml)
