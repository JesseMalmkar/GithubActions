[![Run App Malmkar, Jesse](https://github.com/JesseMalmkar/GithubActions/actions/workflows/ci.yml/badge.svg)](https://github.com/JesseMalmkar/GithubActions/actions/workflows/ci.yml)
